...
<body>
	<div class="container">
		...
		<h1 class="text-center">
			ユーザ情報更新<span class="badge badge-secondary"></span>
		</h1>
		<div class="contents-center">
			<div class="form-group row">
				<label for="inputEmail3" class="col-sm-10 col-form-label"><font
					size="5">ログインID</font> </label>
				<div class="col-sm-2">id0001</div>
			</div>
			<div class="form-group row">
			...
			<div class="nav justify-content-center">
				<a class="btn btn-primary" href="userList.html" role="button">更新</a>
			</div>

			<ul class="nav">
				<li class="nav-item"><a class="nav-link active"href="userList.html">戻る</a></li>
			</ul>
